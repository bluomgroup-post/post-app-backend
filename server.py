...
import os, uuid, random, logging, bcrypt, jwt, smtplib
...
DEMO_MODE = not bool(GMAIL_USER and GMAIL_APP_PASSWORD)
...
def send_otp(email, code):
    ...
    try:
        ...
        msg["Subject"] = "Your POST App verification code"
        msg["From"] = f"POST App <{GMAIL_USER}>"
        msg["To"] = email

        html = f"""
        <div style="font-family:sans-serif;max-width:400px;margin:auto;padding:24px;background:#111;color:#fff;border-radius:16px;">
            <h1 style="color:#FFD600;letter-spacing:6px;">POST</h1>
            <p>Your verification code:</p>
            <div style="font-size:36px;font-weight:900;letter-spacing:10px;color:#FFD600;padding:16px 0;">{code}</div>
